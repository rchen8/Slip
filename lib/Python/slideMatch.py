...
def openFiles(fileNames, targetSize, debug = None):
    ...
    for name in fileNames:
        sift = cv2.SIFT() #TODO: Can this be moved out of the loop for efficiency??
        img = cv2.imread(name)
...
def lcs(a, b):
    """
    Returns the length of the longest common substring of strings a and b
    """
